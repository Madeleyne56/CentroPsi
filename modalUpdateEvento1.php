...
<div class="modal fade" id="modalUpdateEvento1" tabindex="-1" aria-labelledby="updateEventoLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content" style="border-radius: 15px; box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.2);">
      <div class="modal-header" style="background-color: #007bff; color: white; border-radius: 15px 15px 0 0;">
        <h5 class="modal-title" id="updateEventoLabel">Actualizar Evento</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="formEventoUpdate" name="formEventoUpdate" action="UpdateEvento1.php" method="POST">
          ...
          <div class="modal-footer" style="border-top: none;">
            ...
            <button type="submit" class="btn btn-primary" style="background-color: #007bff; border-radius: 20px;">Guardar Cambios</button>
          </div>
        </form>
      </div>
    </div>
